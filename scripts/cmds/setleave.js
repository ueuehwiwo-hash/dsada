	...
	config: {
		...
		guide: {
			vi: {
				...
				attachment: {
					[`${__dirname}/assets/guide/setleave/setleave_vi_1.png`]: __dirname + "/assets/setleave_guide.png"
				}
			},
			en: {
				...
				attachment: {
					[`${__dirname}/assets/guide/setleave/setleave_en_1.png`]: __dirname + "/assets/setleave_guide.png"
				}
			}
		}
	},
